...
class TestController extends Controller{
    ...
    public function test34() {
        ...
        $model = M('Dept');
        // 连贯操作
        $data = $model -> field('name,count(*) as count') -> fetchSql(true) -> groupp('name') -> select();
        dump($data);
    }
    ...
    public function test44() {
        ...
        $model = M('Dept');
        // 联表查询
        $result = $model -> field('t1.*,t2.name as deptname') -> alias('t1') -> join('left join sp_dept ass t2 on t1.pid = t2.pid') -> select();
        // 打印
        dump($result);
    }
